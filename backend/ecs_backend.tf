...
# }
#
# # Example: order-service task definition (replicate for other services)
...
#     {
#       name      = "order-service"
#       image     = "ACCOUNT_ID.dkr.ecr.${var.region}.amazonaws.com/order-service:latest"
#       essential = true
#       portMappings = [
#         {
#           containerPort = 8080
...
#       }
#       environment = [
#         { name = "DYNAMODB_TABLE", value = "orders" },
